		...
		{ --boss
			...
			update=function(self)
				...
				elseif this_action=="eye shoot" then
					...
					if this_timer==0 then
						self.action,self.timer,self.pal="eye wait",30
					end
			...
			flash_eye=function(self)
				self.pal=t\2%2==0 and {[14]=10,[8]=11} or nil
			end,
			draw=function(self)
				for head in all(self.heads) do
...

